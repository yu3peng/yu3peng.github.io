...
* N4：SMF 和 UPF 之间的接口
> 在 3GPP R16 系统架构方面增加了I-SMF，解决了用户移动出当前SMF服务区的时候，如何保证业务连续性。
> 流程方面增加了I-SMF插入、修改和删除过程，以及I-SMF如何建立用户面的分流路径。
> 该功能对于国内运营商来说比较重要，能够保证用户在跨省移动的时候保证业务连续性。在该功能中也增强了UPF分配用户IP地址。
